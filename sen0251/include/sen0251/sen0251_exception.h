...
public:
  explicit MyExceptionBase(const char *in, const char *file,
...
#define THROW(type, msg) throw type(msg, __FILE__, __FUNCTION__, __LINE__)

#define THROW_CLASS(name)                                                      \
  class name : public MyExceptionBase {                                        \
  public:                                                                      \
    explicit name(const char *in, const char *file, const char *function,      \
                  int line)                                                    \
